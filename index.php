...
<div class="row">
<div class="col-lg-6">
<span class="logo">ACM QUIZ PORTAL</span></div>
...
<!-- sign in form begins -->  
  <form class="form-horizontal" name="form" action="sign.php" onSubmit="return validateForm()" method="POST">
<fieldset>
